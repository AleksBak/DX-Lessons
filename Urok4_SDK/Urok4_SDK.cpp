...
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
// Переделанный Урок 4 на 'Windows Kits SDK' (C:\Program Files (x86)\Windows Kits) вместо
// устаревшего 'DirectX SDK (June 2010)' (C:\Program Files (x86)\Microsoft DirectX SDK (June 2010))
// Проект создал как 'Win32 Empty Project'.
//--------------------------------------------------------------------------------------

// некоторые подключаемые хедеры изменились
#include <windows.h>
#include <d3d11_1.h>			// #include <d3d11.h> (#include <wrl/client.h> для COM)
...
HRESULT InitWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(L"Urok4WindowClass", L"Урок 4. Трехмерные преобразования",
...
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
// Поменял функцию компиляции шейдера и некоторые ее параметры
//--------------------------------------------------------------------------------------
							  ...
							  LPCSTR szShaderModel, ID3DBlob** ppBlobOut)
{
	...
	ID3DBlob* pErrorBlob;
	hr = D3DCompileFromFile(szFileName, NULL, NULL, szEntryPoint,
